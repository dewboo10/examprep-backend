...
module.exports = [
    {
      ...
      day: 3,
      section: "VARC",
      passage: `Like Charles Darwin, Alfred Wegener revolutionized an entire science. Unlike Darwin's ideas, which still stir up much controversy, Wegener's theory of drifting continents is accepted almost without question, but it did not succeed without a struggle.
  ...
  => x = 480 / 8 = 60.`,
    ...
    },
    {
      ...
      day: 3,
      section: "LRDI",
      passage: `<p>A metro system connects 6 stations (A, B, C, D, E, F) via bidirectional tracks. The network follows these rules:</p>
  <ul>
  <li>A is connected to B and D.</li>
  <li>B is connected to C and E.</li>
  <li>C is connected to D and F.</li>
  <li>D is connected to E.</li>
  <li>E is connected to F.</li>
  </ul>
  <p>Visual Representation (Network Diagram):</p>
  <pre>A —— B —— C —— F
  |    |    |
  D —— E —— F
  (Note: Lines represent bidirectional tracks.)</pre>`,
  ...
  New minimum stops = 2.`,
    ...
    },
    {
      ...
      day: 3,
      section: "LRDI",
      passage: `<p>A company surveyed 120 employees across three departments (IT, Marketing, Operations) on their proficiency in three skills: Coding (C), Data Analysis (D), and Presentation (P).</p>
  <p>The Venn diagram below shows overlaps (not drawn to scale):</p>
  <pre>Circle C = Coding
  Circle D = Data Analysis
  Circle P = Presentation</pre>
  <p>Additional Data Table:</p>
  <table border="1" cellpadding="4" cellspacing="0">
    <thead>
      <tr>
        <th>Department</th><th>Only C</th><th>Only D</th><th>Only P</th><th>C & D</th><th>D & P</th><th>P & C</th><th>All 3</th><th>None</th>
      </tr>
    </thead>
    <tbody>
      <tr><td>IT</td><td>10</td><td>5</td><td>2</td><td>12</td><td>4</td><td>8</td><td>6</td><td>3</td></tr>
      <tr><td>Marketing</td><td>8</td><td>6</td><td>9</td><td>5</td><td>7</td><td>3</td><td>2</td><td>10</td></tr>
      <tr><td>Operations</td><td>4</td><td>7</td><td>6</td><td>6</td><td>5</td><td>4</td><td>3</td><td>15</td></tr>
    </tbody>
  </table>`,
  ...
  IT has the highest proportion (54%).`,
    ...
    },
    {
      ...
      day: 3,
      section: "LRDI",
      passage: `<p>The table gives the 10 countries with the biggest economies in the world in 2013, as measured by GDP. For each of these countries, the table shows the percent of employment in each of the 3 sectors of the economy: agriculture, industry, and services.</p>
  <table border="1" cellpadding="4" cellspacing="0">
    <thead>
      <tr>
        <th>Country</th><th>Agriculture (%)</th><th>Industry (%)</th><th>Service (%)</th>
      </tr>
    </thead>
    <tbody>
      <tr><td>Brazil</td><td>15.4</td><td>21.9</td><td>62.7</td></tr>
      <tr><td>China</td><td>34.8</td><td>29.5</td><td>35.7</td></tr>
      <tr><td>France</td><td>2.9</td><td>22.2</td><td>74.9</td></tr>
      <tr><td>Germany</td><td>1.5</td><td>28.3</td><td>70.2</td></tr>
      <tr><td>India</td><td>47.2</td><td>24.7</td><td>28.1</td></tr>
      <tr><td>Italy</td><td>3.7</td><td>27.8</td><td>68.5</td></tr>
      <tr><td>Japan</td><td>3.7</td><td>26.3</td><td>70.0</td></tr>
      <tr><td>Russia</td><td>9.7</td><td>27.9</td><td>62.4</td></tr>
      <tr><td>United Kingdom</td><td>1.2</td><td>19.9</td><td>78.9</td></tr>
      <tr><td>United States</td><td>1.6</td><td>16.7</td><td>81.7</td></tr>
    </tbody>
  </table>`,
      question: `For the 10 countries listed, the services sector had the greatest range in percent of employment in 2013.`,
      options: [
        "Yes",
        "No"
      ],
      answerIndex: 0,
      correctAnswer: "Yes",
      explanation: `To compare ranges, calculate the difference between highest and lowest values for each sector:
  
  Agriculture: 47.2 - 1.2 = 46%
  Industry: 29.5 - 16.7 = 12.8%
  Services: 81.7 - 28.1 = 53.6%
  
  Services has the greatest range (53.6%).`,
      videoLink: ""
    },
    {
      id: "nmat-day3-q31",
  ...
  <table border="1" cellpadding="4" cellspacing="0">
    ...
    <tbody>
      ...
      question: `In exactly half of the 10 countries listed, less than 25% of employment in 2013 was in the industry sector.`,
      options: [
        "Yes",
        "No"
      ],
      answerIndex: 0,
      correctAnswer: "Yes",
      explanation: `Count countries with industry employment < 25%:
  
  Brazil (21.9%), France (22.2%), India (24.7%), United Kingdom (19.9%), United States (16.7%) = 5 countries
  
  5 out of 10 = exactly half.`,
      videoLink: ""
    },
    {
      id: "nmat-day3-q32",
  ...
  <table border="1" cellpadding="4" cellspacing="0">
    ...
    <tbody>
      ...
      question: `The listed country with the least percent of employment in the agriculture sector in 2013 had the greatest percent of employment in the services sector in 2013.`,
      options: [
        "Yes",
        "No"
      ],
      answerIndex: 1,
      correctAnswer: "No",
      explanation: `Least agriculture: United Kingdom (1.2%)
  Greatest services: United States (81.7%)
  
  These are different countries, so the statement is false.`,
      videoLink: ""
    }
  ];